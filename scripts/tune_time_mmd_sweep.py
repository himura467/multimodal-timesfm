...
from multimodal_timesfm.types import MultimodalCheckpoint
...
def main() -> int:
    ...
    wandb.agent(sweep_id, function=_sweep_fn, project="multimodal-timesfm-time-mmd", count=parsed_args.count)
